...
$Exam_id=$data['Auto_increment'];
	...
	for( $i=1;$i<=$getting_noq;$i++){
		$work="INSERT INTO objquestions(Examid, qsn_no, question, optionA, optionB, optionC, optionD, Correct_Answer)
     VALUES 
    ($Exam_id, $i, '{$_POST['q'.$i]}', '{$_POST['a'.$i]}', '{$_POST['b'.$i]}', '{$_POST['c'.$i]}', '{$_POST['d'.$i]}', '{$_POST['cans'.$i]}')";
    echo $work;
...
<head>
  ...
  <title>Create Exam-Objectives</title>
<!-- Bootstrap core CSS -->
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">Update Profile</a>
...
<form method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="noq" id="noq" placeholder="How many questions are you creating"><br>
    <button value="Create Exam"  class="btn btn-warning" id="create">Generate Exam</button>
  </div>
...
<div class="modal-footer">
  ...
  <script src="js/obj-script.js"></script>
