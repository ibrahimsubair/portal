...
try {
   ...
   $mail->isSMTP();  
    ...
    $mail->Username   = 'onlineportalbygroup2@gmail.com';                     // SMTP username
    $mail->Password   = 'Anonymous-4';                               // SMTP password
     //$mail->SMTPSecure = 'ssl';        // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('onlineportalbygroup2@gmail.com', 'Online Exam Portal Group 2');
